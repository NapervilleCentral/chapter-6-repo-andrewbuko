    ...
    public static void main(String args[])
    {
        ...
        while(x != 'E' && x != 'e')
        {
            ...
            else if(x == 'r' || x == 'R')
            {
                ...
                {
                    int temp = purse.getNumberofPennies();
                    purse.remove(new Coin('P'));
                    if(temp != purse.getNumberofPennies())
                ...
                {
                    int temp = purse.getNumberofNickels();
                    purse.remove(new Coin('N'));
                    if(temp != purse.getNumberofNickels())
                ...
                {
                    int temp = purse.getNumberofDimes();
                    purse.remove(new Coin('D'));
                    if(temp != purse.getNumberofDimes())
                ...
                {
                    int temp = purse.getNumberofQuarters();
                    purse.remove(new Coin('Q'));
                    if(temp != purse.getNumberofQuarters())
